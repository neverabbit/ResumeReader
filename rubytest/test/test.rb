...
d = "resume/51job_李业武(83608682).mht"

		html_part = Mail.read(d).parts[0]
    # puts html_part
    ...
    # test = html_part.body.decoded.force_encoding(encoding)
    ...
    puts company, 1, department, 1, position_e
		experience = [company, department, position_e].transpose
